...
## Local v2 refinements
- OB SAR per Market Unit changed to the Opportunities-style pie with larger callout typography.
- Top OB Contracts labels now show Contract Name first, then Contract ID.
- Chart tooltips show full non-abbreviated numeric values for SAR/value charts.
- Opportunities and Order Book KPI cards show exact values on hover.
- OB historical trend axes now use rounded, stable tick intervals for SAR and percentage scales.
